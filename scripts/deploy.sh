...
kubectl set image deployment/franklin-site-status-audit-worker audit-worker=docker-experience-success-release.dr-uw2.adobeitc.com/franklin/site-status-audit-worker:$1 -n ns-team-sites-xp-space-cat
